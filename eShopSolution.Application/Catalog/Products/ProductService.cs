...
namespace eShopSolution.Application.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (request.ThumbnailImage != null)
            {
                var thumbnailImage = await
                    _context.ProductImages.FirstOrDefaultAsync(i => i.IsDefault == true && i.ProductId == request.Id);
        ...
        public async Task<ProductVm> GetById(int productId, string languageId)
        {
            ...
            var productTranslation =
                await _context.ProductTranslations.FirstOrDefaultAsync(x => x.ProductId == productId
        ...
        public async Task<PagedResult<ProductVm>> GetAllPaging(GetManageProductPagingRequest request)
        {
            ...
            var query = from p in _context.Products
                        ...
                        //join c in _context.Categories on pic.CaterogyId equals c.Id
            ...
            {
                query = query.Where(p => request.CategoryIds.Contains(p.pic.CaterogyId));
            }*/
        ...
        public async Task<PagedResult<ProductVm>> GetAllByCategoryId(string languageId, GetPublicProductPagingRequest request)
        {
            ...
            {
                query = query.Where(p => p.pic.CaterogyId == request.CategoryId);
            }
            //3. Paging
            int totalRow = await query.CountAsync();
